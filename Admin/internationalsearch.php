...
if (isset($_GET['search'])) {
    ...
    $query = "SELECT * FROM destinations WHERE type = 'international' AND (location LIKE '%$search%' OR name LIKE '%$search%' OR price LIKE '%$search%')";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($conn->query($query) === TRUE) {
        echo "New international destination added successfully";
    } else {
